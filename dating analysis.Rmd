...
```
# How Attrctive influent the results
```{R}
...
# How Sincere influent the results
```{R}
kDataMatch <- aggregatedData[3:10]
matMean <- kmeans(kDataMatch, 7, nstart = 20)
...
# How Intelligent influent the results
```{R}
kDataMatch <- aggregatedData[3:10]
matMean <- kmeans(kDataMatch, 7, nstart = 20)
...
# How Shared Interests influent the results
```{R}
kDataMatch <- aggregatedData[3:10]
matMean <- kmeans(kDataMatch, 7, nstart = 20)
